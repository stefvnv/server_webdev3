...
<header class="w3-bar w3-border w3-pale-red w3-padding-small" style="width: 100%;">
    <h2>Grade Manager - Login</h2>
    <form method="post" action="signUp.jsp">
        <input class="w3-input w3-pale-green w3-round-xlarge" style="width: 10%" type="submit" value="Sign Up">
    </form>
